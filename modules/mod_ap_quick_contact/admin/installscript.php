...
class mod_ap_quick_contactInstallerScript {
        /**
    ...
    function install($parent) {
      echo '
		 <div class="apinstall">
		 <h1><strong>AP Quick Contact Module</strong><span class="pro">FREE</span><small>ver. 3.2</small></h1> 
		 <p><img class="img-rounded" style="float:left;margin:3px 15px 15px 0;" src="../modules/mod_ap_quick_contact/admin/images/ap_quick_contact.png" />AP Quick Contact Module - displays a responsive, bootstrapped, quick <b>contact form</b> with data validation on the fly. For best results, we recommend to choose <b>SMTP</b> as a default mailer in Global Configuration (Global Configuration > Server Settings > Mail Settings > SMTP). It is powered by jQuery. Powerfully simple!</p>
		 ...
		 <style type="text/css">
			...
			.apinstall h1{font-family:Segoe,"Segoe UI","DejaVu Sans","Trebuchet MS",Verdana,Arial,sans-serif;font-size:25px;padding:15px 9px 15px 7px;border-bottom:1px solid #eee;margin:8px 10px 20px;vertical-align:top;line-height:180%;text-indent:7px;color:#595959;font-size:24px;font-weight:normal!important;border-radius:5px;background:transparent url(../modules/mod_ap_bootstrap_carousel/admin/images/logo_backend_gray.png) right 26px no-repeat;}
			.apinstall span.pro{font-size:8px;font-family:Arial,sans-serif;line-height:25px;padding:2px 4px;color:#fff;vertical-align:middle;top:0px;margin-left:7px;position:relative;width:auto;border-radius:3px;background-color:#88B95B;font-style:normal}
			.apinstall small{font-size:9px;font-family:Arial,sans-serif;line-height:25px;padding:1px 4px 1px;color:#fff;vertical-align:middle;top:0px;margin-left:7px;position:relative;width:auto;border-radius:3px;background-color:#AF8272;font-style:normal}
			.apinstall p{margin:10px 22px 10px;line-height:160%;font-size:114%;text-align:left}
			.apinstall a {color:#E16000}
			...
			.apinstall p.lic .check a:hover {color:#E16000}
        ...
        function uninstall($parent) {  
				...
				<div class="apuninstall alert alert-block fade in">
				 ...
				 <p> <strong>AP Quick Contact Module</strong><hr/></p>
        ...
        function update($parent) {
			echo '
			 ...
			 <style type="text/css">
				.apinstall{display:block;margin:0 auto 20px;border:1px solid #ddd;vertical-align:top;padding:0 20px 7px;border-radius:5px;font-family:font-family:"Segoe UI","Myriad Pro",Arial,sans-serif;font-weight:normal;text-align:justify;color:#4d4d4d;line-height:24px;font-size:15px;background-color:#fff}
				.apinstall h1{font-family:Segoe,"Segoe UI","DejaVu Sans","Trebuchet MS",Verdana,Arial,sans-serif;font-size:25px;padding:15px 9px 15px 7px;border-bottom:1px solid #eee;margin:8px 10px 20px;vertical-align:top;line-height:180%;text-indent:7px;color:#595959;font-size:24px;font-weight:normal!important;border-radius:5px;background:transparent url(../modules/mod_ap_quick_contact/admin/images/logo_backend_gray.png) right 26px no-repeat;}
			.apinstall span.pro{font-size:8px;font-family:Arial,sans-serif;line-height:25px;padding:2px 4px;color:#fff;vertical-align:middle;top:0px;margin-left:7px;position:relative;width:auto;border-radius:3px;background-color:#88B95B;font-style:normal}
			.apinstall small{font-size:9px;font-family:Arial,sans-serif;line-height:25px;padding:1px 4px 1px;color:#fff;vertical-align:middle;top:0px;margin-left:7px;position:relative;width:auto;border-radius:3px;background-color:#AF8272;font-style:normal}
			.apinstall p{margin:10px 22px 10px;line-height:160%;font-size:114%;text-align:left}
			.apinstall a {color:#E16000}
