...
jimport('joomla.form.formfield');jimport( 'joomla.html.parameter.element' );
...
class JFormFieldColorpicker extends JFormField
{
	...
	protected function getInput()
	{
		...
		$scriptname	 = $this->element['scriptpath'] ?(string) $this->element['scriptpath'] : $baseurl.'modules/mod_endofslidebox/elements/color-picker.js';
