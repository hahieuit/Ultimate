...
<div class="vmgroup<?php echo $params->get ('moduleclass_sfx') ?>">
	...
	if ($display_style == "div") {
		...
		<div class="vmproduct<?php echo $params->get ('moduleclass_sfx'); ?>">
			...
			<div class="<?php echo $pwidth ?> <?php echo $float ?>" style="margin-bottom:5px;">

				<div class="spacer"><div  class="featureItem_wrapper"><div class="ttn_thumbImg">
					...
					if (!empty($product->images[0])) {
						...
						$image = $product->images[0]->displayMediaThumb ('class="browseProductImage" border="0"  width="90" height="auto" alt="'.$product->product_name.'"', FALSE);
					...
					$url = JRoute::_ ('index.php?option=com_virtuemart&view=productdetails&Itemid=199&virtuemart_product_id=' . $product->virtuemart_product_id . '&virtuemart_category_id=' .$product->virtuemart_category_id); ?>

					<!-- <a href="<?php echo $url ?>"><?php echo $product->product_name ?></a>  /-->      <?php    echo '</div>';
		...
		<ul class="vmproduct<?php echo $params->get ('moduleclass_sfx'); ?>">
			...
			<li class="<?php echo $pwidth ?> <?php echo $float ?>">
				...
				if (!empty($product->images[0])) {
					...
					$image = $product->images[0]->displayMediaThumb ('class="featuredProductImage" border="0" width="90" ', FALSE);
