...
class jsecureViewPwdprotect extends JViewLegacy {
	...
	protected function addToolbar()
	{
		JToolBarHelper::title(JText::_('jSecure Authentication'), 'generic.png');
			JToolBarHelper::apply('applyAdminpwdpro');
			JToolBarHelper::save('saveAdminpwdpro');
   ...
   function sendmail($JSecureConfig, $fieldName){
		...
		$config   = new JConfig();
		 ...
		 if($to){
			...
			$return = JFactory::getMailer()->sendMail($fromEmail, $headers, $to, $subject, $body);
			if ($return !== true) {
