      ...
      <table class="table table-striped">
		...
		<fieldset id="jform_home" class="radio btn-group">
		 ...
		 <tr id="captchakey1">
          ...
          <td class="paramlist_value"><input type="text" name="captchakey" id="captchakey" value="<?php echo $captcha[0]->Value;?>" size="50"/>
          </td>
        </tr>
		...
		<tr id="captchadatasitekey1">
          ...
          <td class="paramlist_value"><input type="text" name="captchadatasitekey" id="captchadatasitekey" value="<?php echo $captchadatasitekey[0]->Value;?>" size="50"/>
          </td>
        </tr>
